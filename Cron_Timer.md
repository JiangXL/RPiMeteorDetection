#Comand to set command run in setting time by Crontab.
crontab -e

# run rmd_bypy.sh while RPI star
# send ip check internet and send ip log. 
22 * * * * /home/pi/Desktop/rmd_bypy.sh
